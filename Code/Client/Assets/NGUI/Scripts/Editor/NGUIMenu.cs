...
#region Create
	...
	static public void AddSprite ()
	{
		...
		{
            GameDebug.Log("You must select a game object first.");
		}
	}
	...
	static public void AddSprite2D ()
	{
        ...
        else GameDebug.Log("You must select a game object first.");
	}
#endif
...
#region Attach
	...
	static public void AddCollider ()
	{
		...
		if (NGUIEditorTools.WillLosePrefab(go))
		{
			...
			{
                GameDebug.Log("You must select a game object first, such as your button.");
			}
		}
	}
