...
public class AIType_1104 : CommonAI
{
    ...
    public AIType_1104(BattleUnit battleUnit)
        : base(battleUnit)
    {
    }
    ...
    {
        return new AIType_1104(battleUnit);
    }
    ...
    private bool CombatChoice()
    {
        ...
        if (choice == 1 && BaseAI.CheckSkillCd(GetID(), mSkill4) && BaseAI.CheckSkillCost(GetID(), mSkill4))
        {
